        ...
        <div className="p-6 rounded-lg shadow-lg space-y-6 br-40">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            >
              ...
              <label
                className="absolute inset-0 w-full h-full flex items-center justify-center rounded-full cursor-pointer opacity-0 group-hover:opacity-100 group-hover:bg-opacity-50 transition-opacity duration-300"
                style={{
