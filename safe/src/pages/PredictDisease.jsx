...
import { FaEvernote, FaGoogle, FaWikipediaW, FaSearch } from "react-icons/fa";
...
const Insurance = () => {
  ...
  async function check() {
    const data = {
      ...
      "Blurred And Distorted Vision":
        symptomsState["Blurred And Distorted Vision"],
      ...
      "Pain During Bowel Movements":
        symptomsState["Pain During Bowel Movements"],
      ...
      "Receiving Blood Transfusion":
        symptomsState["Receiving Blood Transfusion"],
      "Receiving Unsterile Injections":
        symptomsState["Receiving Unsterile Injections"],
      ...
      "History Of Alcohol Consumption":
        symptomsState["History Of Alcohol Consumption"],
  ...
  const googleSearch = () => {
    if (disease) {
      window.open(
        `https://www.google.com/search?q=${encodeURI(disease)}`,
        "_blank"
      );
    }
  };
  const wikipediaSearch = () => {
    if (disease) {
      window.open(
        `https://en.wikipedia.org/wiki/Special:Search?search=${encodeURI(
          disease
        )}`,
        "_blank"
      );
  ...
  return (
    <div className="flex relative dark:bg-main-dark-bg min-h-screen overflow-hidden">
      <div className="dark:bg-main-dark-bg bg-main-bg min-h-screen ml-10 w-full flex flex-col items-center">
        <div
          className="bg-white dark:text-gray-200 dark:bg-secondary-dark-bg p-6 rounded-2xl w-full md:w-1200 mb-4 mx-auto text-gray-200"
          style={{ height: "75vh", overflowY: "auto", marginTop: "2rem" }}
        >
          <div
            className="flex items-center py-2 px-4 rounded-lg bg-white"
            style={{
              maxWidth: "400px",
              marginLeft: "auto",
              marginRight: "0",
          ...
          <div className="flex flex-col items-center justify-start f-500 text-white animate-fadeInScaleUp">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              {filteredSymptoms.map((symptom) => (
                <div
                  key={symptom}
                  className={`flex items-center border border-gray-600 rounded-lg p-4 cursor-pointer hover:bg-gray-500 transition-colors duration-300 space-x-4 text-white ${
                    symptomsState[symptom] ? "bg-green-500" : ""
                  }`}
        ...
        {disease && (
          <div
            className="bg-white dark:text-gray-200 dark:bg-secondary-dark-bg p-6 rounded-2xl w-full md:w-1200 mx-auto text-gray-200"
            style={{
              height: "auto",
              overflowY: "auto",
              marginTop: "2rem",
          ...
          >
            <div className="flex items-center gap-2">
              ...
              <button
                className="bg-blue-500 hover:bg-blue-700 rounded-full p-2 flex items-center justify-center"
              ...
              <button
                className="bg-green-500 hover:bg-green-700 rounded-full p-2 flex items-center justify-center"
                onClick={wikipediaSearch}
                style={{
                  width: "40px",
                  height: "40px",
                  display: "flex",
